 ...
 */
public class AndrochatWidget extends AppWidgetProvider {
    ...
    public void onEnabled(Context context) {
        // Enter relevant functionality for when the first AndrochatWidget is created
    }

    @Override
    public void onDisabled(Context context) {
        // Enter relevant functionality for when the last AndrochatWidget is disabled
    }
}
