...
import com.example.androchat.MainFragment;
...
public class ConversationFragment extends Fragment {
  ...
  private ConversationFragment.OnFragmentInteractionListener mListener;
  ...
  public void onAttach(Context context) {
    ...
    if (context instanceof ConversationFragment.OnFragmentInteractionListener) {
      mListener = (ConversationFragment.OnFragmentInteractionListener) context;
    } else {
